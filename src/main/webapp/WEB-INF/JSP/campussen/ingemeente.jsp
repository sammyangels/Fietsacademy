<%--@elvariable id="fouten" type="be.vdab.servlets.campussen.ingemeenteservlet"--%>
<%--@elvariable id="campussen" type="be.vdab.servlets.campussen.ingemeenteservlet"--%>
...
<html lang="nl">
<head>
    <v:head title="Campussen in ${empty param.gemeente ? 'een gemeente' : param.gemeente}"/>
</head>
<body>
    <v:menu/>
